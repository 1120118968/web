...
<center>
  <table class="zong">
    ...
    <th class="text-center" width=80px; scope="col">点赞</th>
...
{  
	...
	out.println("<tr id='biaoge'><td><img class='picture' src= "+rs.getString("gpicture")+" /></td><td>"+rs.getString("gname")+"</td><td>"+"<span class='glyphicon-yen'></span>"+rs.getString("gprice")+'元'+"</td><td>"+rs.getString("gsold")+"</td><td>"+rs.getString("glike")+"</td><td>"+rs.getString("ginfor")+"</td><td><a target='_blank' href='goods.jsp?ownid="+rs.getString("ownid")+"&gname="+rs.getString("gname")+"'>去评价</a></td></tr>");
	}
	else
	{
    out.println("<tr id='biaoge'><td><img class='picture' src= "+rs.getString("gpicture")+" /></td><td>"+rs.getString("gname")+"</td><td>"+"<span class='glyphicon-yen'></span>"+rs.getString("gprice")+'元'+"</td><td>"+rs.getString("gsold")+"</td><td>"+rs.getString("glike")+"</td><td>"+rs.getString("ginfor")+"</td><td>已评价</td></tr>");
	}
}
stmt.close();
con.close();	

...
<html>
  ...
  <header style="height:30px;background-color:#FFFFCC;margin-top:0px;padding-top:0px;">
...
if(str==null){                                         //用户id为空,没有登录
    out.print("<li><a href='javascript:;' onclick='showRegist()' style='display:inline;float:right; text-decoration:none;height:32px;color:blue;'>注册</a></li>");
    out.print("<li><a href='login.jsp' style='display:inline;float:right;text-decoration:none;height:32px;color:blue'>登录|</a></li>");
    }
	...
	out.print("<li><a style='display:inline;float:right;text-decoration:none;' href='admin.jsp'>");
	out.print("管理员");
	%>
	<%
	out.print("，欢迎您</a>");
	...
	ResultSet rs = stmt.executeQuery(sql);               //读者结果集
	ResultSet rs1 =stmt2.executeQuery(sql1);              //管理员结果集
	...
	{
		String ownid=rs1.getString("ownid");                  //从结果集中找到学号
        ...
        <div class="t_c_cen">
            ...
            <div class="t_c_bottom">
                <ul>
                    ...
                    <li>
                        <a href="help.jsp" style="text-decoration: none;"><em>&nbsp;&nbsp;帮&nbsp;&nbsp;助</em></a>
                    </li>
                    <li>

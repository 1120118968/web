...
%>
  ...
  <tr>
    <td width="29%" valign="top" bgcolor="#FFCC33"><div class="good">
    <%
    	out.println("<img style='background-color:white;' src='" + img + "' alt='' width='100%' height='99%' />");
     %>
    <div style="text-align:start;background-color:#F00;">
    <ul class="simpleul">
    	<li><div id="like" style="display:inline-block;float:left;color:white;size-weight:boid;"><img name="" src="img/like.png" width="26" height="30" alt="" style="float:left;margin-left:5px" /><%out.println(gl); %></div></li>
  ...
  <tr><td colspan="2">
	...
	<div class="evaluate"><p style="font-size:20px;"><img src="img/xiujie.jpg" width='20' height='20' alt=''>二哈的姑奶奶：真不错！</p></div>

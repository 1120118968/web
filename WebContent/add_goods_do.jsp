<%@ page contentType="text/html;charset=utf-8" errorPage="error.jsp" pageEncoding="utf-8"  language="java" import="java.sql.*" import="java.io.*,java.awt.Image,java.awt.image.*,com.sun.image.codec.jpeg.*,java.sql.*,com.jspsmart.upload.*,java.util.*"%>
<%
...
gname = new String(gname.getBytes("gbk"), "utf-8");
...
ginfor = new String(ginfor.getBytes("gbk"), "utf-8");

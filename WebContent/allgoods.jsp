...
<%                                       
	...
	if(rs.next()){                                      //按名结果集不为空
		...
		out.print("<img class='picture' src= "+rs.getString("gpicture")+" /></a></td><td>"+rs.getString("gname")+"</td><td>"+"<span class='glyphicon-yen'></span>"+rs.getString("gprice")+'元'+"</td><td>"+rs.getString("gsold")+"</td><td>"+rs.getString("glike")+"</td><td>"+rs.getString("ginfor")+"</td>");
